...
2. **PPP Conversion for Health Expenditure**  
    ...
    - **Formula**: $$ \text{Undervaluation} = \frac{\text{PPP Rate} - \text{Official Rate}}{\text{PPP Rate}} \times 100% $$
    - **Hint**: Refer to the lecture’s burger price example: $$ \text{Undervalued by} = \frac{2.89 - 4.42}{2.89} = -53% $$.
3. **Inflation Rate Calculation**  
    ...
    - **Hint**: Use the lecture’s burger price example: $$ \text{Inflation Rate} = \frac{6.60 - 6.00}{6.00} = 10% $$.
